...
rules_final <- apriori(transactions, 
                      parameter = list(support = 0.35,
                                     confidence = 0.8,  # Añadido parámetro de confianza
                                     target = "rules",  # Cambiado a "rules" en lugar de "frequent"
                                     minlen = 3, 
                                     maxlen = 4))

# Inspección de reglas ordenadas por lift
